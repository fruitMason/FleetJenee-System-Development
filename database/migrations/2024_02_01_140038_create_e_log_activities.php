...
class CreateELogActivities extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('e_log_activities', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('title')->nullable()->index();
            $table->unsignedBigInteger('e_log_id')->nullable()->index();
    ...
    {
        Schema::dropIfExists('e_log_activities');
    }
}
