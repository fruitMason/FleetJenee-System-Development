...
class CarRegistrationDataTable extends DataTable
{
    /**
            ...
            ->addColumn('action', function ($row) {
                if (strtolower($row->status) == 'due_maintenance')
                    return '<div class="dropdown dropdown-action">' .
                        ...
                        'onclick="editNotify(' . $row->id . ')"><i class="fa fa-pencil m-r-5"></i> Edit</a>' .
                        '<a class="dropdown-item" href="#"' .
                        'onclick="deleteNotify(' . $row->id . ')"><i class="fa fa-trash-o m-r-5"></i> Delete</a>' .
                        '<a class="dropdown-item" href="#" onclick="archiveNotify(' . $row->id . ')"><i class="fa fa-archive m-r-5"></i> Archive</a>' .
                        '<a class="dropdown-item" href="#"' .
                        'onclick="maintainNotify(' . $row->id . ')"><i class="fa fa-car m-r-5"></i> Send to Maintenance</a>' .
                        '<a class="dropdown-item" href="' . route('fleet.vehicle.odometer.history', $row->id) . '"><i class="fa fa-history m-r-5"></i> Odometer History</a>' .
                        '</div></div>';
