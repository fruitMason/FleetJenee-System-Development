...
class TaxDataTable extends DataTable
{
        ...
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                return '<div class="btn-group" role="group" aria-label="Action buttons">' .
                    '<a class="btn btn-xs btn-success" href="#" target="_self"><i class="fa fa-eye text-white" aria-hidden="true"></i></a>' .
    ...
    {
        $query = Tax::query()->orderByDesc('created_at');
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('percentage')->addClass('text-center no-border'),
