...
//                return $row->drivers->count().' Driver(s)' ?? 'N/A';
//            })
            ...
            ->addColumn('action', function ($row) {
                return '<div class="btn-group" role="group" aria-label="Action buttons">' .
                    ...
                    'onclick="resolve('.$row->id.')"><i class="fa fa-edit text-white" aria-hidden="true"></i></a>' .
    ...
    {
        $query = Vendor::query()->with(['region'])->orderByDesc('created_at');
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('phone_number')->addClass('text-center no-border'),
            Column::make('service_type')->addClass('text-center no-border'),
//            Column::make('drivers')->addClass('text-center no-border'),
