...
class ArchivedDepartmentDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('sector', function ($row) {
                return $row->region->sector->name ?? 'N/A';
            })
    ...
    {
        $query = Department::query()->with(['region'])
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('sector')->title('Zone')->addClass('text-center no-border'),
    ...
    {
        return 'ArchivedDepartmentDataTable_' . date('YmdHis');
    }
}
