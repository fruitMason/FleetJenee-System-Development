...
class GarageReceiptDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('receipt_date', function ($row) {
                return Carbon::parse($row->receipt_date)->format('D, d F Y') ?? 'N/A';
            })
            ->editColumn('receipt_comment', function ($row) {
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('receipt_date')->addClass('text-center no-border'),
            Column::make('receipt_comment')->addClass('text-center no-border'),
