        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Usage Request</h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="col-auto float-end ms-auto">
                        ...
                        <a href="{{ route('inventory.usage.admin') }}" class="btn add-btn"><i class="fas fa-tools"></i>
                            Usage Request - Stock Out
                        </a>
        ...
        $(document).ready(function() {
            ...
            $('#btnStatusFilter').on('click', function() {
                ...
                $('#dataTableBuilder').DataTable().ajax.url(
                    '{{ route('inventory.usage.index') }}?filter=' + filterValue).load();
            });
        });
    </script>
