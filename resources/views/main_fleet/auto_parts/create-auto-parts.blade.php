        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Create New Auto Part</h3>
                        <ul class="breadcrumb">
            ...
            <section class="panel panel-default">
                <div class="card mg-b-20" id="card_content">
                    <div class="card-body">
                        <div class="card-title">New Auto Part</div>


                        <form method="post" action="{{ route('auto.parts.store') }}"
                            onsubmit="return SubmitDelete(this,'Save Auto Part');">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="unit_cost" id="unit_cost" step="0.1"
                                        class="form-control" required value="{{ old('unit_cost') }}">
                                </div>
                            </div>
