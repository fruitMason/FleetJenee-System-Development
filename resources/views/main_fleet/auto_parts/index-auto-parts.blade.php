        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Auto Parts</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('inventory.index') }}">Auto Parts Inventory</a>
                            </li>
                            <li class="breadcrumb-item active">Auto Parts Setup</li>
                        </ul>
                    </div>


                    <div class="col-auto float-end ms-auto">
                        <a href="{{ route('auto.parts.create') }}" class="btn add-btn"><i class="fas fa-tools"></i>
                            Add New Part</a>
                        <a href="{{ route('inventory.index') }}" class="btn add-btn"><i class="fa fa-arrow-left"></i>
                            Auto Parts Inventory</a>
                    </div>
                </div>
            </div>
