        ...
        <div id="sidebar-menu" class="sidebar-menu">
            {{-- <nav class="greedys sidebar-horizantal">
                <ul class="list-inline-item list-unstyled links">
                    ...
                    <li>
                        <a href="clients.html"><i class="la la-dashboard"></i> <span>Dashboard</span></a>
                    </li>
                    ...
                    <li>
                        <a href="clients.html"><i class="la la-users"></i> <span>Settings</span></a>
                    </li>

                    <li>
                        <a href="tickets.html"><i class="la la-ticket"></i> <span>Staff</span></a>
                    </li>

                    <li>
                        <a href="tickets.html"><i class="la la-ticket"></i> <span>Service Providers</span></a>
                    </li>
                ...
                <ul class="hidden-links hidden">
                    ...
                    <li class="submenu">
                        <a href="admin-dashboard.html#"><i class="la la-graduation-cap"></i> <span> Performance </span>
                    ...
                    <li class="submenu">
                        <a href="admin-dashboard.html#"><i class="la la-crosshairs"></i> <span> Goals </span> <span
                    ...
                    <li class="submenu">
                        <a href="admin-dashboard.html#"><i class="la la-edit"></i> <span> Training </span> <span
                                class="menu-arrow"></span></a>
                        <ul style="display: none;">
                    ...
                    <li class="submenu">
                        <a href="admin-dashboard.html#"><i class="la la-briefcase"></i> <span> Jobs </span> <span
                                class="menu-arrow"></span></a>
                        <ul style="display: none;">
                    ...
                    <li class="submenu">
                        <a href="admin-dashboard.html#"><i class="la la-user"></i> <span> Profile </span> <span
                                class="menu-arrow"></span></a>
                        <ul style="display: none;">
                    ...
                    <li class="submenu">
                        <a href="admin-dashboard.html#"><i class="la la-key"></i> <span> Authentication </span> <span
                                class="menu-arrow"></span></a>
                        <ul style="display: none;">
                    ...
                    <li class="submenu">
                        <a href="admin-dashboard.html#"><i class="la la-exclamation-triangle"></i> <span> Error Pages
                    ...
                    <li class="submenu">
                        <a href="admin-dashboard.html#"><i class="la la-hand-o-up"></i> <span> Subscriptions </span>
                            <span class="menu-arrow"></span></a>
                        <ul style="display: none;">
                    ...
                    <li class="submenu">
                        <a href="admin-dashboard.html#"><i class="la la-columns"></i> <span> Pages </span> <span
                                class="menu-arrow"></span></a>
                        <ul style="display: none;">
                    ...
                    <li class="submenu">
                        <a href="admin-dashboard.html#"><i class="la la-object-group"></i> <span> Forms </span> <span
                                class="menu-arrow"></span></a>
                        <ul style="display: none;">
                    ...
                    <li class="submenu">
                        <a href="admin-dashboard.html#"><i class="la la-table"></i> <span> Tables </span> <span
                                class="menu-arrow"></span></a>
                        <ul style="display: none;">
                    ...
                    <li>
                        <a href="admin-dashboard.html#"><i class="la la-file-text"></i> <span>Documentation</span></a>
                    </li>
                    <li>
