    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="row filter-row">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="form-group form-focus select-focus">
                        <select class="select floating" id="statusGroupFilter">
                            <option>-- Select Fin Status --</option>
                ...
                <div class="col-sm-6 col-md-3">
                    <button type="button" id="btnFilterWorkOrders" class="btn btn-success w-100"> Filter </button>
                </div>
            </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnFilterWorkOrders').on('click', function() {
                var filterValue = $('#statusGroupFilter').val();
                console.log(filterValue);


                $('#dataTableBuilder').DataTable().ajax.url(
                    '{{ route('accounts.orders') }}?filter=' + filterValue).load();
            });
        });
    </script>
