<div id="add_elog_modal" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add New ELog</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" placeholder="Enter the Title" name="title" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="col-form-label">Odometer Number <span class="text-danger">*</span></label>
                                        <input type="number" placeholder="Enter the Odometer no#" name="start_odometer" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control" placeholder="Enter the Current Location" name="current_location" rows="7"></textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="col-form-label">Destination <span class="text-danger">*</span></label>
                                        <textarea class="form-control" placeholder="Enter the destination" name="destination" rows="7"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" placeholder="Enter Any Other Information" name="description" rows="7"></textarea>
                                    </div>
                                </div>
                            </div>
