<div id="add_odometer_modal" class="modal custom-modal fade" role="dialog">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="old_odometer" class="form-control" value="{{auth()->user()->car->odometer}}" disabled>
                                    </div>
                                    <div class="col-md-6">
