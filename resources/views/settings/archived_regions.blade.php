    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Archived Regions</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Settings</a></li>
                        <li class="breadcrumb-item active">Archived Regions</li>
                    </ul>
                </div>
            </div>
        </div>
...
@section('js')
    ...
    <script>
        function unarchiveNotify(regionId) {
            if (confirm("Are you sure you want to unarchive this region?")) {
                $.ajax({
                    url: '{{ route("regions.unarchive") }}', // Ensure this route is set up
                    type: 'POST',
                    data: {
                        id: regionId,
                    ...
                    error: function(response) {
                        alert('Error unarchiving region.');
                    }
                });
            }
        }
