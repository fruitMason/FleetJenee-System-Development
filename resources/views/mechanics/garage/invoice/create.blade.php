...
@section('content')
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <form role="form" onsubmit="return false;" method="post" id="formInvoice" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="vendor_id" name="vendor_id" value="{{$vendor->id}}" class="form-control" type="hidden"/>
                                    <input id="vendor" name="vendor" value="{{$vendor->name}}" class="form-control" type="text" readonly>
                                </div>
                            </div>
                        ...
                        <div class="row" id="row_item_table">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-dark ml-3 mt-3 mb-3" id="add_prod_btn"><span class="fa fa-plus-circle"></span> Add Line Item</a>
                                </div>
                            </div>
                        </div>
...
@section('js')
    ...
    @include('mechanics.garage.invoice.scripts')
