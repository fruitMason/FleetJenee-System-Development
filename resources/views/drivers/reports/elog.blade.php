...
@section('page_title', 'Elog Report')
@section('css')
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">ELog Report</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Driver</a></li>
                            <li class="breadcrumb-item active">ELog Report</li>
                        </ul>
                    </div>
    ...
    <script>
        function updateELogNotify(id) {
            ajax('{{ route('driver.report.elog.get') }}', {
                ...
                $('#edit_id').val(data.id);
                $('#update_elog_modal').modal('show');
            });
        }
    </script>

    <script>
        function showEndTripModal(id) {
            console.log("Show End Trip Modal called with ID:", id);
            $('#end_trip_id').val(id);
        ...
        function submitEndTrip() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#end_trip_modal').modal('hide');
                    location.reload();
                },
                error: function(xhr) {
                    const errors = xhr.responseJSON.errors;
                    alert(errors.end_odometer ? errors.end_odometer[0] : 'An error occurred');
                }
            });
        }
    </script>
