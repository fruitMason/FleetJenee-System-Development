...
@section('js')
    ...
    <script>
        ...
        function resolveNotify(id) {
            swal({
                title: "<small>Reason for resolving this accident?</small>",
                input: "textarea",
        ...
        function _resolve(id, reason) {
            ajax('{{route('fleet.vehicle.reports.accident.resolve')}}', {
                id: id,
                reason: reason,
                _token: _token
